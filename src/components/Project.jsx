...
const container = 'bg-slate-950 md:w-[400px] md:h-[330px] w-[260px] h-[270px] p-3 rounded-xl flex items-center flex-col ease-in-out duration-500 hover:scale-110 shadow-md shadow-black'
